...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, reward, recipients, poolAddress){
    ...
    this.serializeHeader = function() {
        ...
        if (this.rpcData.hashUTXORoot) {
            ...
            header.write(this.rpcData.hashUTXORoot, position, 32, 'hex');  // hashUTXORoot  0-32
            header.write(this.rpcData.hashStateRoot, position += 32, 32, 'hex');  // hashStateRoot  32-64
            position += 32;
        }
